    ...
    2: function (e, t, n) {
        ...
        void 0 === (r = "function" == typeof (o = function () {
            ...
            !function (e) {
                ...
                const y = {name: "NO ZONE"}, v = "notScheduled", b = "scheduling", T = "scheduled", E = "running",
                    w = "canceling", Z = "unknown", S = "microTask", D = "macroTask", P = "eventTask", C = {}, O = {
                        symbol: s,
                        currentZoneFrame: () => z,
                        onUnhandledError: N,
                ...
                function T(e, o, s) {
                    ...
                    if (null === e[g]) {
                        ...
                        if (!1 !== o && s instanceof D && s.hasOwnProperty(g) && s.hasOwnProperty(_) && null !== s[g]) w(s), T(e, s[g], s[_]); else if (!1 !== o && "function" == typeof h) try {
                ...
                const P = e[c] = e.Promise, C = t.__symbol__("ZoneAwarePromise");
                let O = o(e, "Promise");
            ...
            const R = {useG: !0}, x = {}, L = {}, M = new RegExp("^" + i + "(\\w+)(true|false)$"),
                A = u("propagationStopped");

            function H(e, t) {
                const n = (t ? t(e) : e) + "false", o = (t ? t(e) : e) + "true", r = i + n, s = i + o;
            ...
            function F(e, t, o) {
                const r = o && o.add || "addEventListener", s = o && o.rm || "removeEventListener",
                    ...
                    h = "." + r + ":", p = function (e, t, n) {
                        ...
                        const n = this || t.target || e, o = n[x[t.type].false];
                        ...
                        if (!(t = t || e.event)) return;
                        const n = this || t.target || e, o = n[x[t.type].true];
                        if (o) if (1 === o.length) p(o[0], n, t); else {
                            const e = o.slice();
                            for (let o = 0; o < e.length && (!t || !0 !== t[A]); o++) p(e[o], n, t)
                        }
                ...
                function g(t, o) {
                    ...
                    if (y[l]) return !1;
                    const v = o && o.eventNameToString, b = {}, T = y[l] = y[r], E = y[u(s)] = y[s], w = y[u(a)] = y[a],
                        Z = y[u(c)] = y[c];
                    let S;
                    ...
                    const P = p ? function (e) {
                        ...
                        }, j = Zone[u("BLACK_LISTED_EVENTS")], I = e[u("PASSIVE_EVENTS")],
                        A = function (t, n, r, s, a = !1, i = !1) {
                            return function () {
                                ...
                                const f = N && !!I && -1 !== I.indexOf(l), d = D(arguments[2], f);
                                ...
                                const k = !!d && ("boolean" == typeof d || d.capture),
                                    y = !(!d || "object" != typeof d) && d.once, T = Zone.current;
                                let E = x[l];
                                E || (H(l, v), E = x[l]);
                                ...
                                const C = c.constructor.name, O = L[C];
                    ...
                    return y[r] = A(T, h, P, O, k), S && (y.prependListener = A(S, ".prependListener:", (function (e) {
                        ...
                        const r = arguments[2], s = !!r && ("boolean" == typeof r || r.capture), a = arguments[1];
            ...
            const W = ["absolutedeviceorientation", "afterinput", "afterprint", "appinstalled", "beforeinstallprompt", "beforeprint", "beforeunload", "devicelight", "devicemotion", "deviceorientation", "deviceorientationabsolute", "deviceproximity", "hashchange", "languagechange", "message", "mozbeforepaint", "offline", "online", "paint", "pageshow", "pagehide", "popstate", "rejectionhandled", "storage", "unhandledrejection", "unload", "userproximity", "vrdisplayconnected", "vrdisplaydisconnected", "vrdisplaypresentchange"],
                U = ["encrypted", "waitingforkey", "msneedkey", "mozinterruptbegin", "mozinterruptend"], V = ["load"],
                ...
                K = ["close", "error", "open", "message"], Q = ["error", "message"],
            ...
            Zone.__load_patch("legacy", e => {
                ...
                !function (e) {
                    ...
                    const y = D(f, "open", () => function (e, t) {
                        ...
                        }), v = u("fetchTaskAborting"), b = u("fetchTaskScheduling"),
